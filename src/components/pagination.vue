<template>
  <div class="container">
            <ul>
                ...
                <span v-if="qre_for">
                    <li v-for="i in qre_for" @click="page_jump(start_page+i-1)" :key="i">
                        <a>{{start_page+i-1}}</a>
                    </li>
                </span>               
                <li class="active">
                ...
                <span v-if="lat_for">
                    <li v-for="i in lat_for" @click="page_jump(current_page_+i)">
                        <a>{{current_page_+i}}</a>
                    </li>
                </span>
...
export default {
    ...
    methods:{
        ...
        page_jump(index){
            ...
            this.uppage();
            /* console.log('组件内页面跳转');
            console.log(this.current_page_); */
            this.change_page(this.current_page_);
        }
    },
    watch:{
...
.container ul li:hover{
    border:1px solid rgb(236, 97, 22);
}
.container ul li.active{
    background-color:rgb(236, 97, 22);
    color: white;
}
